        ...
        <div class="p-6">
            <div v-if="!speech.isSupported" class="text-red-600">
                ...
                <a href="https://caniuse.com/mdn-api_speechsynthesis" target="_blank"
                    class="text-blue-500 underline">更多详情</a>
            </div>
            <div v-else>
                <el-form>
                    ...
                    <el-form-item label="语言">
                        <el-select v-model="voice" placeholder="选择语言">
                            ...
                            <el-option v-for="(voice, i) in voices" :key="i" :label="`${voice.name} (${voice.lang})`"
                                :value="voice" />
                        </el-select>
                    </el-form-item>
                    ...
                    <el-form-item>
                        <div class="flex space-x-4">
                            <el-button type="primary" :disabled="speech.isPlaying.value" @click="play">
                                {{ speech.status.value === 'pause' ? '继续' : '朗读' }}
                            </el-button>
                            <el-button type="warning" :disabled="!speech.isPlaying.value" @click="pause">
                                暂停
                            </el-button>
                            <el-button type="danger" :disabled="!speech.isPlaying.value" @click="stop">
                                停止
                            </el-button>
                        </div>
                    </el-form-item>
