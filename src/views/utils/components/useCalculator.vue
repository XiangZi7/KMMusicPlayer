...
<template>
  <div
    class="p-2 bg-gray-50 dark:bg-gray-800 rounded-lg shadow-lg transition-colors duration-300"
  >
    ...
    <div class="mt-4">
      <el-button type="success" @click="calculate" class="w-full"
        >等于</el-button
      >
      <el-button type="danger" @click="clear" class="w-full mt-2"
        >清除</el-button
      >
